jQuery(function ($) {
  ...
  $(window).on('load', function () {
    ...
    // Isotope'u .creative (Öğretmen) sınıfına sahip öğeleri gösterecek şekilde başlatın
    $portfolio.isotope({
      itemSelector: '.portfolio-item',
      layoutMode: 'fitRows',
      filter: '.creative', // İlk filtreyi öğretmen olarak ayarlıyoruz
    });

    // Öğretmen sekmesini başlangıçta aktif yap
    $portfolio_selectors.removeClass('active');
    $(".portfolio-filter > li > a[data-filter='.creative']").addClass('active');

    // Filtreleme butonlarına tıklama işlevini ekleyin
